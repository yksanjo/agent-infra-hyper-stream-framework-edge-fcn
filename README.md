# agent-infra-hyper-stream-framework-edge-fcn

## Detailed Description

agent-infra-hyper-stream-framework-edge-fcn is a iot-focused project that evaluates device telemetry and operational anomalies to improve fleet reliability and safety.  
